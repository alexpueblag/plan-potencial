...
const TEXTOS_SEMILLA = [
  ...
  ["p0_t3", "Te contactamos en menos de 12 horas", ""],
  ...
  ["p3_frente_help", "Lo que da la calle. El fondo lo calculamos nosotros.", ""],
  ...
  ["p5_sub",
   "Tu Masterdeveloper te contacta en menos de 12 horas para coordinar tu videollamada gratis. Sin compromiso.",
   ""],
  ...
  ["mdev_frase",
   ...
   ""],
  ["r_paso1",
   "<b>Te contactamos en menos de 12 horas</b> para confirmar tu videollamada gratis con tu Masterdeveloper.",
   ""],
  ["r_paso2",
